...
const nextConfig = {
  ...
  env: {
    ...
    BINARY2048_RECOVERY_SECRET: process.env.BINARY2048_RECOVERY_SECRET ?? "",
    ...
    BINARY2048_RATE_LIMIT_STORE: process.env.BINARY2048_RATE_LIMIT_STORE ?? "memory",
    BINARY2048_MONGO_RATE_LIMIT_COLLECTION: process.env.BINARY2048_MONGO_RATE_LIMIT_COLLECTION ?? "rate_limits",
    BINARY2048_MONGO_RATE_LIMIT_TIMEOUT_MS: process.env.BINARY2048_MONGO_RATE_LIMIT_TIMEOUT_MS ?? "3000",
    BINARY2048_BOT_API_KEY_HASHES: process.env.BINARY2048_BOT_API_KEY_HASHES ?? "",
